...
class NewVistitorTest(StaticLiveServerTestCase):                   # inherits from unittest.TestCase which lays out the framework for unit testing
    ...
    # any method within the test case class starting with 'test' will be automatically run
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        # Now a new users, Francis, comes along to the site. 
